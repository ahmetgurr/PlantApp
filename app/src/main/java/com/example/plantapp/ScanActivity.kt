...
import com.example.plantapp.databinding.ActivityScanBinding
...
class ScanActivity : AppCompatActivity() {
        ...
        navView.setOnNavigationItemSelectedListener { menuItem ->
            when (menuItem.itemId) {
                R.id.navigation_dashboard -> {
                    // Dashboard öğesine tıklandığında Main aktivitesine geçiş yapılacak işlemler
                    val intent = Intent(this, MainActivity::class.java)
                    startActivity(intent)
                    true
                }
                R.id.navigation_notifications -> {
                    // Notification öğesine tıklandığında Main aktivitesine geçiş yapılacak işlemler
                    val intent = Intent(this, MainActivity::class.java)
                    startActivity(intent)
                    true
                }
    ...
    private fun outputGenerator(bitmap: Bitmap) {
        ...
        val plantmodel = AutoModel3.newInstance(this)
